declare module "gui" {
  ...
  export class Image {
    ...
    isEmpty(): boolean;
    setTemplate(is: boolean): void;
    isTemplate(): boolean;
    getSize(): SizeF;
    getScaleFactor(): number;
    tint(color: string | number): Image;
  }
  ...
  export class View extends Responder {
    ...
    addTooltipForRect(tooltip: string, rect: RectF): number;
  ...
  export class Browser extends View {
    ...
    getCookiesForURL(url: string, callback: Function): void;
    goBack(): void;
    canGoBack(): boolean;
    goForward(): void;
    ...
    beginAddingBindings(): void;
    endAddingBindings(): void;
    onClose: any;
    onUpdateCommand: any;
    onChangeLoading: any;
    onUpdateTitle: any;
  ...
  export class Locale {
    protected constructor();
    static getCurrentIdentifier(): string;
  ...
  export class Event {
    ...
    static getMouseLocation(): PointF;
    type: EventType;
    modifiers: number;
    timestamp: number;
  }
  ...
  export type BlendMode = "normal" | "multiply" | "screen" | "overlay" | "darken" | "lighten" | "color-dodge" | "color-burn" | "soft-light" | "hard-light" | "difference" | "exclusion" | "hue" | "saturation" | "color" | "luminosity" | "clear" | "copy" | "source-in" | "source-out" | "source-atop" | "destination-over" | "destination-in" | "destination-atop" | "xor";
  ...
  export type ColorName = "text" | "disabled-text" | "text-edit-background" | "disabled-text-edit-background" | "control" | "window-background";
  ...
  export type VibrantMaterial = "appearance-based" | "light" | "dark" | "titlebar" | "selection" | "menu" | "popover" | "sidebar" | "header-view" | "sheet" | "window-background" | "hudwindow" | "fullscreen-ui" | "tooltip" | "content-background" | "under-window-background" | "under-page-background";
