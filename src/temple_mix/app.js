  ...
  els.forEach(async (el) => {
    ...
    const material = new ShaderMaterial({
      uniforms: {
        ...
        uHover: { value: 0 },
        uTex0: { value: await loadTex("/img/red.png") },
        uTex1: { value: await loadTex("/img/blue.png") },
        uTex2: { value: await loadTex("/img/texture1.png") },
        uTex3: { value: await loadTex("/img/uv.jpg") },
        uTex4: { value: await loadTex("/img/gray2.png") },
        uTick: { value: 0 },
        uProgress: { value: 0 },
      },
      vertexShader,
